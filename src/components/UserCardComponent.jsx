...
const UserCardComponent = ({ user }) => {
    ...
    return (
        <Link to={`/users/${user.id}`} className='card flex flex-col max-w-[400px] w-full h-60 p-7 gap-3 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 cursor-pointer flex-shrink-0'>
