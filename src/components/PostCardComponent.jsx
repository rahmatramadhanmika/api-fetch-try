...
const PostCardComponent = ({ post, author }) => {
    ...
    return (
        <div className='card flex flex-col max-w-[650px] h-72 w-full p-7 gap-3 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 cursor-pointer flex-shrink-0'>
